...
import { logout } from '../util/AuthenticationService'; 
...
// Definição do componente Footer diretamente aqui
function Footer() {
    return (
            ...
            <section style={{ backgroundColor: '#0f172a', padding: '4em 0' }}>
                <div className="container">
                    <div id="carouselTecnologia" className="carousel slide" data-bs-ride="carousel">
                        ...
                        <button className="carousel-control-prev" type="button" data-bs-target="#carouselTecnologia" data-bs-slide="prev" aria-label="Previous slide">
                            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span className="visually-hidden">Anterior</span>
                        </button>
                        <button className="carousel-control-next" type="button" data-bs-target="#carouselTecnologia" data-bs-slide="next" aria-label="Next slide">
