    ...
    <div style={{ backgroundColor: "#0a192f", color: "#ffffff" }}>
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2em" }}>
          ...
          >
            Descubra espaços tecnológicos para exposições inesquecíveis. Conecte
            ideias e oportunidades em ambientes de alto padrão.
          </p>
          <motion.button
            as={Link}
          ...
          >
            Explorar Stands{" "}
            <span style={{ marginLeft: 12, fontSize: 22 }}>→</span>
          </motion.button>
        </div>
      </section>
          ...
          >
            <div style={{ flex: "1 1 300px", minWidth: 260, maxWidth: 350 }}>
              ...
              <p style={{ color: "#cbd5e1", fontSize: 17 }}>
                Garanta seu espaço no próximo evento e destaque seu negócio.
                Vagas limitadas, visibilidade garantida!
              </p>
            </div>
            <div style={{ flex: "1 1 300px", minWidth: 260, maxWidth: 350 }}>
              <motion.div {...iconHover}>
              ...
              <p style={{ color: "#cbd5e1", fontSize: 17 }}>
                Layouts prontos, infraestrutura completa e suporte. Você só
                chega, monta e vende.
              </p>
            </div>
            <div style={{ flex: "1 1 300px", minWidth: 260, maxWidth: 350 }}>
              ...
              <p style={{ color: "#cbd5e1", fontSize: 17 }}>
                Seu stand em destaque com nossa vitrine digital. Mais olhos no
                seu produto, mais chances de fechar negócios.
              </p>
            </div>
          </div>
        </div>
